        ...
        <ul>
          <li class="item" v-for="item in listData" :key="item.id">
            ...
            <div class="clearfix item-bottom">
              ...
              <div class="item-btn">
                <div class="item-stu" @click="goSubjectCount(item.product_type)">学科分类统计</div>
                <div class="item-res" @click="goContentCount(item.product_type)">内容分类统计</div>
              </div>
            </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods:{
       ...
       * 去申报情况
       */
      goSubjectCount(product_type){
        console.log(product_type);
        this.$router.push({name:'临床决策情况统计',params:{product_type:product_type,index:1}});
      },
      /**
       * 去申报结果
       */
      goContentCount(product_type){
        this.$router.push({name:'临床决策情况统计',params:{product_type:product_type,index:2}});
      },
      /**
       * 加载更多
       */
